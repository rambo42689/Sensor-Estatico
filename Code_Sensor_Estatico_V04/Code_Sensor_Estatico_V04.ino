...
boolean Trigger_On = false, File_open = false, forca_alta = false;
float tempo_inicial = 0, buttonState = 0; //Definindo as flags e o tempo inicial do "Timer" para desligamento automático
//-----------------------------------------------------------------------
